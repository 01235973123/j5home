...
<div id="osm-members-list" class="osm-container">
	...
	?>
    <<?php echo $hTag; ?> class="osm-page-title">
        <?php echo $this->params->get('page_heading') ?: Text::_('OSM_MEMBERS_LIST'); ?></<?php echo $hTag; ?>>
    <?php
	}
    ...
    <form method="post" name="adminForm" id="adminForm"
        action="<?php echo Route::_('index.php?option=com_osmembership&view=members&Itemid=' . $this->Itemid); ?>">
        <fieldset class="filters btn-toolbar <?php echo $clearfixClass; ?>">
            <?php echo $this->loadTemplate('search'); ?>
        </fieldset>
        <table
            class="<?php echo $bootstrapHelper->getClassMapping('table table-striped table-bordered table-hover'); ?> osm-responsive-table">
            <thead>
                <tr>
                    <?php
					if ($showAvatar) {
						$cols++;
					?>
                    <th class="osm-members-list-heading-avatar">
					...
					if ($showMembershipId) {
						$cols++;
					?>
                    <th class="osm-members-list-heading-membership-id">
					...
					if ($showPlan) {
						$cols++;
					?>
                    <th class="osm-members-list-heading-plan">
					...
					?>
                    <th class="osm-members-list-heading-<?php echo $field->name; ?>">
                        <?php
					...
					if ($showSubscriptionDate) {
						$cols++;
					?>
                    <th class="<?php echo $centerClass; ?> osm-members-list-heading-created-date">
					...
					if ($showSubscriptionEndDate) {
						$cols++;
					?>
                    <th class="<?php echo $centerClass; ?> osm-members-list-heading-to-date">
                ...
                <tr>
                    ...
                    <td class="tdno<?php echo $i; ?>" data-content="<?php echo Text::_('OSM_AVATAR'); ?>">
                        <?php
								...
								?>
                        <a href="<?php echo $link; ?>"><img class="oms-avatar <?php echo $imgCircle; ?>"
                                src="<?php echo $rootUri . '/media/com_osmembership/avatars/' . $row->avatar; ?>" /></a>
                        <?php
									} else {
									?>
                        <img class="oms-avatar <?php echo $imgCircle; ?>"
                            src="<?php echo $rootUri . '/media/com_osmembership/avatars/' . $row->avatar; ?>" />
                        <?php
									}
								}
								?>
                    ...
                    <?php
						...
						if ($showMembershipId) {
						?>
                    <td class="<?php echo $centerClass; ?> tdno<?php echo $i; ?>"
                        data-content="<?php echo Text::_('OSM_MEMBERSHIP_ID'); ?>">
                        <?php echo OSMembershipHelper::formatMembershipId($row, $this->config); ?></td>
                    <?php
						}
						?>
                    <td class="tdno<?php echo $i; ?>" data-content="<?php echo Text::_('OSM_NAME'); ?>">
                        <?php
							...
							?>
                        <a
                            href="<?php echo $link; ?>"><?php echo rtrim($row->first_name . ' ' . $row->last_name); ?></a>
                        <?php
							} else {
                    ...
                    <?php
						...
						?>
                    <td class="<?php echo $centerClass; ?> tdno<?php echo $i; ?>"
                        data-content="<?php echo Text::_('OSM_SUBSCRIPTION_DATE'); ?>">
                    ...
                    <?php
						...
						?>
                    <td class="<?php echo $centerClass; ?> tdno<?php echo $i; ?>"
                        data-content="<?php echo Text::_('OSM_SUBSCRIPTION_END_DATE'); ?>">
