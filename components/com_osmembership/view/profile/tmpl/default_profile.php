...
<div id="field_existing_profile_avatar" class="<?php echo $controlGroupClass; ?>">
    ...
    <div class="<?php echo $controlsClass; ?>">
        <img class="oms-avatar"
            src="<?php echo Uri::base(true) . '/media/com_osmembership/avatars/' . $this->item->avatar; ?>" />
...
<div id="field_username" class="<?php echo $controlGroupClass; ?>">
    ...
    <div class="<?php echo $controlsClass; ?>">
        ...
        <input type="text" name="username" id="username1"
            class="validate[required,minSize[2],ajax[ajaxUserCall]]<?php echo $this->bootstrapHelper->getFrameworkClass('uk-input', 1); ?> form-control"
            value="<?php echo $this->escape($this->input->post->getUsername('username', $this->item->username)); ?>"
...
<div class="<?php echo $controlGroupClass; ?>">
    <div class="<?php echo $controlLabelClass; ?>">
        <?php echo Text::_('OSM_EVENT_REGISTRATION_CAPACITY'); ?>
    </div>
    <div class="<?php echo $controlsClass; ?>">
        <?php echo $this->item->event_registration_capacity; ?>
    </div>
</div>
<?php
}
...
<div class="form-actions">
    <input type="submit" class="<?php echo $bootstrapHelper->getClassMapping('btn btn-primary'); ?>"
        value="<?php echo Text::_('OSM_UPDATE'); ?>" id="osm-btn-update-profile" />
    <input type="button" class="<?php echo $bootstrapHelper->getClassMapping('btn btn-primary'); ?>"
        value="<?php echo Text::_('OSM_LOGOUT'); ?>" onclick="document.osm_logout_form.submit();" id="osm-btn-logout" />
</div>
<?php
/**
 * @package        Joomla
