                ...
                <div class="floatleft width100">
                    <h1 class="inlineblockdisplay">
						...
						if(($configClass['active_market_status'] == 1) && ($row->isSold > 0))
						{
							?>
                        <span
                            class="marketstatuspropertydetails"><?php echo OSPHelper::returnMarketStatus($row->isSold);?></span>
                        <?php
						}
        ...
        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
            <div class="<?php echo $bootstrapHelper->getClassMapping('span8'); ?>">
                <div class="property-details-main-div">
                    <?php echo HTMLHelper::_($tabApiPrefix.'startTabSet', 'propertyDetailsTab', array('active' => 'tabphoto')); ?>
                    <?php echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyDetailsTab', 'tabphoto', Text::_('OS_PHOTO')); ?>
                    <div class="tab-pane active">
                        <?php
							  ...
							  ?>
                        <script type="text/javascript"
                            src="<?php echo Uri::root()?>media/com_osproperty/assets/js/colorbox/jquery.colorbox.js">
                        </script>
                        <?php
                        ...
                        <div id="slider1" class="favslider1 margin0">
                            ...
                            <ul class="favs">
                                <?php
									   ...
									   {
											if($photos[$i]->image != "" && file_exists(JPATH_ROOT.'/images/osproperty/properties/'.$row->id.'/medium/'.$photos[$i]->image))
											{
												$srcArr[] = '{src: "'.$photos[$i]->image.'", description: "'.$photos[$i]->image_desc.'"}';
												?>
                                <li>
                                    <a class="" href="#" onClick="openSlideshow(<?php echo $i;?>)">
                                        <img src="<?php echo Uri::root()?>images/osproperty/properties/<?php echo $row->id;?>/medium/<?php echo $photos[$i]->image?>"
                                            alt="<?php echo $photos[$i]->image_desc;?>"
                                ...
                                <?php
											...
											{
												?>
                                <li><img src="<?php echo Uri::root()?>media/com_osproperty/assets/images/nopropertyphoto.png"
                                        alt="<?php echo $photos[$i]->image_desc;?>"
                                        title="<?php echo $photos[$i]->image_desc;?>" />
                                    <?php
                                ...
                                <?php 
									for($i=0;$i<count($photos);$i++)
									{
										if($photos[$i]->image != "")
										{
											...
											{
												?>
                                <li <?php if ($i>0) {?>style="margin-left: 3px;width:120px !important;"
                                    <?php }else{ ?>style="width:120px !important; " <?php } ?>><img class="detailwidth"
                                        alt="<?php echo $photos[$i]->image_desc;?>"
                                        title="<?php echo $photos[$i]->image_desc;?>"
                                        src="<?php echo Uri::root()?>images/osproperty/properties/<?php echo $row->id;?>/thumb/<?php echo $photos[$i]->image?>" />
                                </li>
                                <?php
											}
											else
											{
												?>
                                <li <?php if ($i>0) {?>style="margin-left: 3px;width:120px !important;"
                                    <?php }else{ ?>style="width:120px; !important;" <?php } ?>><img
                        ...
                        <?php } 
								...
								else
								{
									?>
                        <img
                            src="<?php echo Uri::root(true)?>/media/com_osproperty/assets/images/nopropertyphoto.png" />
                        <?php
								}
								?>
                        ...
                        <script
                            src="<?php echo Uri::root(true)?>/components/com_osproperty/templates/default/js/main.js">
                        </script>
                    </div>
                    ...
                    <?php
						...
						{
							?>
                    <?php echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyDetailsTab', 'tabgoogle', Text::_('OS_MAP')); ?>
                    <div class="tab-pane">
                        <div id="map_canvas"
                    ...
                    <?php
							if($configClass['map_type'] == 0)
							{
								...
								{
									echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyDetailsTab', 'tabstreet', Text::_('OS_STREET_VIEW'));
									?>
                    <div class="tab-pane">
                        <div id="pano" style="height: <?php echo $configClass['property_map_height']?>px; width: 100%;">
                        </div>
                    </div>
                    <?php
						...
						if($row->pro_video != "")
						{
							echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyDetailsTab', 'avideo', Text::_('OS_VIDEO'));
							?>
                    <div class="tab-pane" id="tabvideo">
                        <?php
								...
								if (stripos(strtolower($row->pro_video), "iframe") === false) {
									?>
                        <iframe src="<?php echo $row->pro_video; ?>" allowfullscreen="allowfullscreen" frameborder="0"
                ...
                <div class="tasks-box">
                    ...
                    <ul class="pf-sharebar-icons">
                        <li>
                            ...
                            <a href="https://www.facebook.com/share.php?u=<?php echo $url;?>" target="_blank"
                                class="btn btn-sm btn-o btn-facebook"
                                title="<?php echo Text::_('OS_ASK_YOUR_FACEBOOK_FRIENDS');?>" id="link2Listing"
                                rel="canonical">
                                <i class="edicon edicon-facebook"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://twitter.com/intent/tweet?original_referer=<?php echo $url;?>&tw_p=tweetbutton&url=<?php echo $url;?>"
                                target="_blank" class="btn btn-sm btn-o btn-twitter"
                                title="<?php echo Text::_('OS_ASK_YOUR_TWITTER_FRIENDS');?>" id="link2Listing"
                                rel="canonical">
                    ...
                    <div class="theme3-container-tasks">
                        <div class="icon-container">
                            ...
                            <a href="<?php echo Route::_("index.php?option=com_osproperty&task=direction_map&id=".$row->id."&Itemid=".Factory::getApplication()->input->getInt('Itemid'))?>"
                                title="<?php echo Text::_('OS_GET_DIRECTIONS')?>" class="link-icon">
                            ...
                            <span id="compare<?php echo $row->id;?>">
								...
								if(! OSPHelper::isInCompareList($row->id)) {
									...
									$msg = str_replace("'","\'",$msg);
									?>
                                <a onclick="javascript:osConfirmExtend('<?php echo $msg; ?>','ajax_addCompare','<?php echo $row->id ?>','<?php echo Uri::root() ?>','compare<?php echo $row->id;?>','theme3','details')"
                                ...
                                <a onclick="javascript:osConfirmExtend('<?php echo $msg; ?>','ajax_removeCompare','<?php echo $row->id ?>','<?php echo Uri::root() ?>','compare<?php echo $row->id;?>','theme3','details')"
                                    href="javascript:void(0)"
                                    title="<?php echo Text::_('OS_REMOVE_FROM_COMPARE_LIST')?>" class="link-icon">
                                    <i class='edicon edicon-copy'></i>
                                </a>
                                <?php
								}
                            ...
                            <span id="fav<?php echo $row->id;?>">
                                <?php
										...
										$msg = str_replace("'","\'",$msg);
										?>
                                <a onclick="javascript:osConfirmExtend('<?php echo $msg;?>','ajax_addFavorites','<?php echo $row->id?>','<?php echo Uri::root()?>','fav<?php echo $row->id; ?>','theme3','details');"
                                    title="<?php echo Text::_('OS_ADD_TO_FAVORITES');?>" class="link-icon">
                            ...
                            <span id="fav<?php echo $row->id;?>">
                                ...
                                <a onclick="javascript:osConfirmExtend('<?php echo $msg;?>','ajax_removeFavorites','<?php echo $row->id?>','<?php echo Uri::root()?>','fav<?php echo $row->id; ?>','theme3','details')"
                                    href="javascript:void(0)" class="link-icon"
                                    title="<?php echo Text::_('OS_REMOVE_FAVORITES');?>">
                                    <i class='edicon edicon-floppy-disk'></i>
                                </a>
                            </span>
                            <?php 
							...
							?>
                            <a target="_blank"
                                href="<?php echo Uri::root()?>index.php?option=com_osproperty&tmpl=component&no_html=1&task=property_print&id=<?php echo $row->id?>"
                                class="link-icon" title="<?php echo Text::_('OS_PRINT_THIS_PAGE')?>">
                            ...
                            <div class="profile-card">
                                ...
                                <a href="<?php echo $link; ?>">
                                    <img class="profile-img"
                                        src="<?php echo Uri::root()."images/osproperty/agent/thumbnail/".$row->agentdetails->photo ?>"
                                        alt="<?php echo $row->agentdetails->name;?>" />
                                </a>
                                <?php
										}
										?>
        ...
        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>" id="propertydetailspage">
            <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> margintop10">
                <div class="tab-content padding0 margin0">
                    <?php
					echo HTMLHelper::_($tabApiPrefix.'startTabSet', 'property', array('active' => 'overviewtab'));
					?>
                    <?php
					echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'overviewtab', Text::_('OS_OVERVIEW', true));
					?>
                    <div class="tab-pane active <?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                        <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> noleftmargin ">
                                ...
                                <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
									...
									for($f = 1; $f < 10 ; $f++)
									{
										...
										if($row->{$name} != "")
										{
											...
											?>
                                    <div
                                        class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> documentElement">
                                        ...
                                        <div class="media-info">
                                            ...
                                            <a href="<?php echo $fileUrl; ?>"
                                                title="<?php echo Text::_('OS_PROPERTY_DOCUMENT')?>"
                                                alt="<?php echo Text::_('OS_PROPERTY_DOCUMENT')?>" target="_blank"
                            ...
                            <div
                                class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> noleftmargin marginbottom10">
                                <div
                                    class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?> noleftmargin padding0">
                                    <?php
                            ...
                            <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> noleftmargin">
                                <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> noleftmargin">
                                    ...
                                    <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                                        <div
                                            class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> noleftpadding paddingtop20">
                                            <h4>
							...
							if(count($row->extra_field_groups) > 0)
							{
								...
								for($i=0;$i<count($extra_field_groups);$i++)
								{
									...
									?>
                            <div
                                class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> noleftmargin paddingtop20">
                                <h4>
                                    <?php echo $group_name;?>
                                </h4>
                            </div>
                            ...
                            <div class='<?php echo $bootstrapHelper->getClassMapping('row-fluid');?> minheight0'>
                                <?php
													$k = 0;
												}
											}
					...
					?>
                    <?php
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'agenttab', OSPHelper::loadAgentType($row->agent_id));
						?>
                    <div class="tab-pane">
                        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                            <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> margintop10">
					...
					?>
                    <?php
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'walkscoretab',Text::_('OS_WALK_SCORE'));
						?>
					...
					?>
                    <?php
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'sharingtab',Text::_('OS_SHARING'));
						?>
                    <div class="tab-pane">
                        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                            <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> margintop10">
					...
					?>
                    <?php
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'request_more_details_tab',Text::_('OS_REQUEST_MORE_INFOR'));
						?>
					...
					?>
                    <?php
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'reviewtab',Text::_('OS_REVIEW'));
						?>
					...
					?>
                    <?php
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'educationtab',Text::_('OS_EDUCATION'));
						?>
					...
					if($row->tour_link != "")
					{
						echo HTMLHelper::_($tabApiPrefix.'addTab', 'property', 'tourtab',Text::_('OS_VIRTUAL_TOUR'));
						?>
                    <div class="tab-pane" id="tourtab">
                        <?php
								if (stripos(strtolower($row->tour_link), "iframe") === false) {
				
									?>
                        <iframe src="<?php echo $row->tour_link; ?>" allowfullscreen="allowfullscreen" frameborder="0"
                            height="480" width="100%"></iframe>
                        <?php
								}
								else
            ...
            <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
                    <div class="shell">
                        <fieldset>
                            <legend><span><i
                                        class="edicon edicon-bubbles3"></i>&nbsp;<?php echo Text::_('OS_JCOMMENTS')?></span>
                            </legend>
                        </fieldset>
                        <?php
