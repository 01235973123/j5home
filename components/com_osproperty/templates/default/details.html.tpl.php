        ...
        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                            ...
                            <ul class="favs">
                                ...
                                <li><a class="propertyphotogroup"
                                        href="<?php echo Uri::root()?>images/osproperty/properties/<?php echo $row->id;?>/<?php echo $photos[$i]->image?>"><img
                                            ...
                                            title="<?php echo $photos[$i]->image_desc;?>" /></a>
                                    <?php
            ...
            <div class="property-details-main-div">
                <ul class="nav nav-tabs marginbottom0">
                    <li class="active" id="liaphoto"><a href="#tabphoto" id="aphoto"
                    ...
                    <?php
						...
						{
							?>
                    <li id="liavideo"><a href="#tabvideo" data-toggle="tab"
                            id="avideo"><?php echo Text::_('OS_VIDEO');?></a></li>
                    <?php
						}
						?>
                </ul>
            ...
            <ul class="pf-sharebar-icons">
                <li>
                    ...
                    <a href="https://www.facebook.com/share.php?u=<?php echo $url;?>" target="_blank"
                        ...
                        title="<?php echo Text::_('OS_ASK_YOUR_FACEBOOK_FRIENDS');?>" id="link2Listing" rel="canonical">
                ...
                <li>
                    <a href="https://twitter.com/intent/tweet?original_referer=<?php echo $url;?>&tw_p=tweetbutton&url=<?php echo $url;?>"
                        ...
                        title="<?php echo Text::_('OS_ASK_YOUR_TWITTER_FRIENDS');?>" id="link2Listing" rel="canonical">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <ul class="pf-sharebar-others">
                <?php
                    if($row->panorama != "")
                    {
                        ?>
                <li>
                    <a rel="{handler: 'iframe', size: {x: 650, y: 420}}"
                        href="<?php echo Uri::root()?>index.php?option=com_osproperty&tmpl=component&no_html=1&task=property_showpano&tmpl=component&id=<?php echo $row->id?>"
                        title="<?php echo Text::_('OS_SHOW_PANORAMA_PICTURE')?>" class="osmodal">
                ...
                <li>
                    ...
                    <span id="fav<?php echo $row->id;?>">
                        <a class="inactivated"
                            onclick="javascript:osConfirmExtend('<?php echo $msg;?>','ajax_addFavorites','<?php echo $row->id?>','<?php echo Uri::root()?>','fav<?php echo $row->id; ?>','default','details')"
                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            ?>
                    <span id="fav<?php echo $row->id;?>">
                        <a onclick="javascript:osConfirmExtend('<?php echo $msg;?>','ajax_removeFavorites','<?php echo $row->id?>','<?php echo Uri::root()?>','fav<?php echo $row->id; ?>','default','details')"
                ...
                <li>
                    ...
                    <span id="compare<?php echo $row->id;?>">
                        <a class="inactivated"
                            onclick="javascript:osConfirmExtend('<?php echo $msg; ?>','ajax_addCompare','<?php echo $row->id ?>','<?php echo Uri::root() ?>','compare<?php echo $row->id;?>','default','details')"
                    ...
                    <span id="compare<?php echo $row->id;?>">
                        <a class="activated"
                            onclick="javascript:osConfirmExtend('<?php echo $msg; ?>','ajax_removeCompare','<?php echo $row->id ?>','<?php echo Uri::root() ?>','compare<?php echo $row->id;?>','default','details')"
                ...
                <?php
                    ...
                    if($row->pro_pdf != "")
                    {
                        ?>
                <li>
                    <a href="<?php echo $row->pro_pdf?>" title="<?php echo Text::_('OS_OPEN_PROPERTY_DOCUMENT')?>"
                        alt="<?php echo Text::_('OS_OPEN_PROPERTY_DOCUMENT')?>" target="_blank">
                ...
                <li>
                    <?php
                            ...
                            ?>
                    <a href="<?php echo $fileUrl ;?>" title="<?php echo Text::_('OS_DOWNLOAD_PROPERTY_DOCUMENT')?>"
                        alt="<?php echo Text::_('OS_DOWNLOAD_PROPERTY_DOCUMENT')?>" target="_blank">
                ...
                <li>
                    <a class="reportmodal"
                        href="<?php echo Uri::root()?>index.php?option=com_osproperty&tmpl=component&item_type=0&task=property_reportForm&id=<?php echo $row->id?>"
