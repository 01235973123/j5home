...
<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>" id="propertydetails">
	<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
			...
			<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
				...
				?>
					...
					<span>
						...
						?>
						<?php if(($configClass['use_sold'] == 1) && ($row->isSold == 1) && ($show_sold == 1)){
							?>
							...
							<div class="descriptionWrap">
								<ul class="attribute-list">
									...
									if($configClass['use_squarefeet'] == 1)
									{
									 ...
									 ?>
									 <?php
									 if(($configClass['use_parking'] == 1) && ($row->parking != "")){
									 ?>
									 ...
									 if($configClass['show_feature_group'] == 1){
										if(($configClass['use_nfloors'] == 1) && ($row->number_of_floors != "")){
										?>
		...
		<div class="os_property-item clearfix">
			...
			<div class="property-meta clearfix">
				<ul class="listingActions-list">
					...
					<li class="propertyinfoli">
						...
						<a href="<?php echo Route::_("index.php?option=com_osproperty&task=direction_map&id=".$row->id."&Itemid=".Factory::getApplication()->input->getInt('Itemid'))?>" title="<?php echo Text::_('OS_GET_DIRECTIONS')?>">
			...
			<!-- features-->
			<?php
			if((($configClass['show_amenity_group'] == 1) && ($row->amens_str1 != "")) || ($row->core_fields != "")){
			?>
				<div class="features">
                                    ...
                                    <?php } ?>
                                        <div class="<?php echo $bootstrapHelper->getClassMapping('span8'); ?>">
                                            ...
                                            ?>
                                                <ul class="attribute-list">
                                                    <?php
                                                    if(($agentdetails->phone != "") && ($configClass['show_agent_phone'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->mobile != "") && ($configClass['show_agent_mobile'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->fax != "") && ($configClass['show_agent_fax'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->yahoo != "") && ($configClass['show_agent_linkin'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->gtalk != "") && ($configClass['show_agent_gplus'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->skype != "") && ($configClass['show_agent_skype'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->msn != "") && ($configClass['show_agent_msn'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if(($agentdetails->facebook != "") && ($configClass['show_agent_facebook'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
                                                        <?php echo Text::_('OS_FACEBOOK');?>:
                                                       <span>
                                                    ...
                                                    if(($agentdetails->aim != "") && ($configClass['show_agent_twitter'] == 1)){
                                                    ?>
                                                       <li class="property-icon-square meta-block">
						...
						<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
							<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
								<div class="tabs clearfix">
									...
									elseif(($configClass['show_walkscore'] == 1) && ($configClass['ws_id'] != ""))
									{
									...
									elseif(($configClass['energy'] == 1) && (($row->energy > 0) || ($row->climate > 0)))
									{
										$activate_tab = "epc";
									}
									...
									elseif(($configClass['show_request_more_details'] == 1) && ($configClass['show_agent_details'] == 0))
									{
									...
									elseif(($configClass['use_property_history'] == 1) && (($row->price_history != "") || ($row->tax != "")))
									{
										$activate_tab = "historytab";
									}
								   
									echo HTMLHelper::_($tabApiPrefix.'startTabSet', 'propertyinformation', array('active' => $activate_tab));

									
									
									if($row->pro_video != "")
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'video', Text::_('OS_VIDEO', true));
									...
									if(($configClass['show_walkscore'] == 1) && ($configClass['ws_id'] != ""))
									{
										...
										{
											echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'walkscore', Text::_('OS_WALK_SCORE', true));
											echo $row->ws;
											echo HTMLHelper::_($tabApiPrefix.'endTab');
										}
									}
									...
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'comment', Text::_('OS_COMMENTS', true));
										echo $row->comments;
									...
									if($row->tour_link != "")
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'tourtab',Text::_('OS_VIRTUAL_TOUR'));
										?>
										<?php
									...
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'epc', Text::_('OS_EPC', true));
									...
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'tellafriend', Text::_('OS_SHARING', true));
										echo HelperOspropertyCommon::sharingForm($row,$itemid); 
										echo HTMLHelper::_($tabApiPrefix.'endTab');
									}
									
									if(($configClass['show_request_more_details'] == 1) && ($configClass['show_agent_details'] == 0))
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'requestmoredetailsform', Text::_('OS_REQUEST_MORE_INFOR', true));
										echo HelperOspropertyCommon::requestMoreDetails($row,$itemid); 
										echo HTMLHelper::_($tabApiPrefix.'endTab');
									}
									if($configClass['integrate_education'] == 1)
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'educationtab', Text::_('OS_EDUCATION', true));
										echo stripslashes($row->education);
										echo HTMLHelper::_($tabApiPrefix.'endTab');
									}
									if(($configClass['use_property_history'] == 1) && (($row->price_history != "") || ($row->tax != "")))
									{
										echo HTMLHelper::_($tabApiPrefix.'addTab', 'propertyinformation', 'historytab', Text::_('OS_HISTORY_TAX', true));
