...
?>
		<script type="text/javascript">
			...
			function setMarkers(map, locations) {
				...
				for (var i = 0; i < locations.length; i++) {
					...
					var image = new google.maps.MarkerImage(imagelink, new google.maps.Size(36, 31), new google.maps.Point(0, 0),
				...
				?>
						makeMarker({
							...
							icon: new google.maps.MarkerImage(
								'<?php echo Uri::root() ?>media/com_osproperty/assets/images/<?php echo $icon ?>')
						});
					<?php
					} else {
					?>
	...
	?>
		...
		<script type='text/javascript' src='<?php echo Uri::root() ?>media/com_osproperty/assets/js/markerclusterer.js'
			defer="defer"></script>
		<script type="text/javascript">
			var map;
			var panorama;
			...
			?>
					var propertyListing<?php echo $rows[$key]->id ?> = new google.maps.LatLng(<?php echo $rows[$key]->lat_add; ?>,
	...
	public static function loadGoogleMapDetails($property, $configClass, $style = "", $toggleposition = 0)
	{
		...
		<script type="text/javascript">
			...
			var citymap = {};
			citymap['chicago'] = {
				center: new google.maps.LatLng(<?php echo $property->lat_add ?>, <?php echo $property->long_add ?>),
		...
		?>
			<div id="toggle">
				<input type="button" id="togglebtn" class="btn btn-info btn-small"
					value="<?php echo Text::_('OS_TOGGLE_STREET_VIEW'); ?>" onclick="toggleStreetView();" />
			</div>
		<?php } ?>
	...
	?>
		...
		?>
			<div id="toggle">
				<input type="button" id="togglebtn" class="btn btn-info btn-small"
					value="<?php echo Text::_('OS_TOGGLE_STREET_VIEW'); ?>" onclick="toggleStreetView1();" />
			</div>
		<?php } ?>
	...
	?>
		<div id="YMapsID" style="<?php echo $style; ?>"></div>
		<div id="YMapsCredit" class="zhym-credit"></div>
		<div id="YMapsMainRoutePanel">
			<div id="YMapsMainRoutePanel_Total"></div>
		</div>
		<div id="YMapsRoutePanel">
			<div id="YMapsRoutePanel_Description"></div>
			<div id="YMapsRoutePanel_Total"></div>
			<div id="YMapsRoutePanel_Steps"></div>
		</div>
		<script type="text/javascript">
			/*<![CDATA[*/
			...
			function initialize() {
				...
				clustermarkers0 = [];
				markerCluster0 = new ymaps.Clusterer({
					maxZoom: 14,
				...
				placemark1.options.set("iconImageHref",
					"<?php echo Uri::root() ?>media/com_osproperty/assets/images/googlemapicons/<?php echo $type_icon; ?>");
