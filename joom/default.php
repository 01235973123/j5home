...
<div id="donation-history-page" class="<?php echo $rowFluidClass." ".$extralayoutCss;?> jd-container">
    ...
    <form action="<?php echo Route::_('index.php?option=com_jdonation&Itemid='.$this->Itemid); ?>" method="post"
                ...
                <tr>
                    ...
                    <td class="" data-label="<?php echo Text::_('JD_PAID'); ?>">
						...
						else
						{
							...
							?>
                        <BR />
                        <a href="<?php echo Route::_('index.php?option=com_jdonation&task=donation.processPayment&id='.$row->id.'&Itemid='.$this->Itemid);?>"
                            title="<?php echo Text::_('OS_MAKE_PAYMENT');?>">
                    ...
                    <td class="center" data-label="<?php echo Text::_('JD_DONATION_RECEIPT'); ?>">
                        <?php
							if($this->config->generated_invoice_for_paid_donation_only)
							{
								...
								{
									?>
                        <a href="<?php echo Route::_('index.php?option=com_jdonation&task=download_receipt&id='.$row->id); ?>"
                            title="<?php echo Text::_('JD_DOWNLOAD'); ?>"><?php echo Text::_('JD_DOWNLOAD'); ?></a>
                        <?php
								}
							}
							else
                    ...
                    <td class="center" data-label="<?php echo Text::_('JD_CANCEL_DONATION'); ?>">
                        ...
                        <a href="javascript:void(0);" class="btn btn-warning"
                            onclick="javascript:cancelRecurringDonation(<?php echo $row->id;?>);">
                            <?php echo Text::_('JD_CANCEL_DONATION');?>
                        </a>
                        <?php
                                        }
...
function cancelRecurringDonation(id) {
    ...
    if (answer == 1) {
        location.href =
            "<?php echo Uri::root(); ?>index.php?option=com_jdonation&task=donation.cancelrecurringdonation&id=" + id;
    }
}
</script>