...
class JFormFieldCkspacer extends FormField {
	...
	protected function testPatch($component) {
		if (File::exists(JPATH_ROOT.'/modules/mod_maximenuck/helper_'.$component.'.php')) {
			$this->element['icon'] = 'accept.png';
			return Text::_('MOD_MAXIMENUCK_SPACER_'.strtoupper($component).'_PATCH_INSTALLED');
		}
		return false;
	}
