...
class JFormFieldCktestslideshowhikashopplugin extends FormField {
	...
	protected function testPatch($component) {
		if (File::exists(JPATH_ROOT . '/plugins/system/' . $component . '/' . $component . '.php') && PluginHelper::isEnabled('system', $component)) {
			$this->element['icon'] = 'accept.png';
			return Text::_('PLG_SLIDESHOWCKHIKASHOP_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
		}
		return false;
	}
