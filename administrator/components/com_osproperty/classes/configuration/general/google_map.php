		...
		<table>
			<tr>
				<td class="key" width="50%" style="border:1px solid #DDD;background-color:#efefef;">
					...
					<input size="5" class="<?php echo$inputMiniClass; ?>" type="text" name="configuration[goole_default_lat]" id="er_declat" size="25" maxlength="100" value="<?php echo $thedeclat;?>" />
				</td>
				<td class="key" style="padding-left:10px;border:1px solid #DDD;background-color:#efefef;" width="50%">
					<?php echo Text::_( 'Longitude' ); ?>
					<input size="5" class="<?php echo$inputMiniClass; ?>" type="text" name="configuration[goole_default_long]" id="er_declong" size="25" maxlength="100" value="<?php echo $thedeclong;?>" />
				</td>
			</tr>
		</table>
	</div>
