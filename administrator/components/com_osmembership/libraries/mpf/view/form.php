...
trait MPFViewForm
{
	 ...
	 * @return void
	 */
	protected function text(string $name, string $title, string $description = '', string $class = 'form-control'): void
	{
	 ...
	 * @return void
	 */
	protected function password(string $name, string $title, string $description = '', string $class = 'form-control'): void
	{
		$type = 'password';
	 ...
	 * @return void
	 */
	protected function number(string $name, string $title, string $description = '', string $class = 'form-control', $attributes = []): void
	{
		$type = 'number';
