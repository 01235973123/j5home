...
if (!in_array('emails', $fields)) {
    $sql = "ALTER TABLE  `#__osmembership_fields` ADD  `emails` TEXT NULL DEFAULT '';";
    $db->setQuery($sql);
    $db->execute();
}
?>
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm"
    ...
    if ($useTabs) {
        ...
        echo HTMLHelper::_('uitab.addTab', 'field', 'general-page', Text::_('OSM_GENERAL'));
    }
    ?>
    <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
        <div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['assignment' => ['1', '-1']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="form-control" type="text" name="name" id="name" size="40" maxlength="250"
                            value="<?php echo $this->item->name; ?>"
                            <?php if ($this->item->is_core) echo 'readonly="readonly"'; ?> />
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="7" cols="40" name="description"
                            class="form-control"><?php echo $this->item->description; ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Email', 'Email', 'Number', 'Tel', 'Textarea', 'Password']]); ?>'>
                    <div class="control-label">
            ...
            <?php
            if (isset($this->lists['field_mapping']) || isset($this->lists['newsletter_field_mapping']) || PluginHelper::isEnabled(
                'osmembership',
                'userprofile'
            )) {
            ?>
            ...
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Email']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group">
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('synchronize_data', Text::_('OSM_FIELD_SYNCHRONIZE_DATA'), Text::_('OSM_FIELD_SYNCHRONIZE_DATA_EXPLAIN')); ?>
                    </div>
                    <div class="controls">
                        <?php echo OSMembershipHelperHtml::getBooleanInput('synchronize_data', $this->item->synchronize_data); ?>
                    </div>
                </div>
                <?php
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="form-control" type="text" name="extra" id="extra" size="40" maxlength="250"
                            value="<?php echo $this->escape($this->item->extra); ?>" />
                    </div>
                </div>
            </fieldset>
        </div>
        <div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['File']]); ?>'>
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <input type="text" name="allowed_file_types" class="form-control"
                            value="<?php echo $this->item->allowed_file_types; ?>" size="40" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Number', 'Range']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    ...
                    <div class="controls">
                        <input type="number" name="step" value="<?php echo $this->item->step; ?>"
                            class="form-control" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => 'List']); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['List', 'Checkboxes', 'Radio']]); ?>'>
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('values', Text::_('OSM_VALUES'), Text::_('OSM_EACH_ITEM_IN_ONELINE')); ?>
                    </div>
                    <div class="controls">
                        <textarea rows="5" cols="40" name="values"
                            class="form-control"><?php echo $this->item->values; ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="40" class="form-control"
                            name="default_values"><?php echo $this->item->default_values; ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('emails', Text::_('OSM_EMAILS'), Text::_('OSM_EMAILS')); ?>
                    </div>
                    <div class="controls">
                        <textarea rows="5" cols="40" class="form-control"
                            name="emails"><?php echo $this->item->emails; ?></textarea>
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Number', 'List', 'Checkboxes', 'Radio', 'Range']]); ?>'>
                    <div class="control-label">
                ...
                ?>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon($showOnData); ?>'>
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('fee_values', Text::_('OSM_FEE_VALUES'), Text::_('OSM_EACH_ITEM_IN_ONELINE')); ?>
                    </div>
                    <div class="controls">
                        <textarea rows="5" cols="40" class="form-control"
                            name="fee_values"><?php echo $this->item->fee_values; ?></textarea>
                    </div>
                </div>
                <?php
                $showOnData = [
                ...
                <div class="control-group"
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" size="40" name="fee_formula"
                            value="<?php echo $this->item->fee_formula; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fee_field' => '1']); ?>'>
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('fee_usage', Text::_('OSM_FEE_USAGE'), Text::_('OSM_FEE_USAGE_EXPLAIN')); ?>
                    </div>
                    <div class="controls">
                        <?php echo $this->lists['fee_usage']; ?>
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fee_field' => '1']); ?>'>
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Tel', 'Range', 'Number']]); ?>'>
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('input-mask', Text::_('OSM_INPUT_MASK')); ?>
                    </div>
                    <div class="controls">
                        <input type="text" class="form-control" size="50" name="input_mask"
                            value="<?php echo $this->escape($this->item->input_mask); ?>" />
                        <div class="form-text"><?php echo Text::_('OSM_INPUT_MASK_EXPLAIN') ?></div>
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['List', 'SQL']]); ?>'>
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('prompt_text', Text::_('OSM_PROMPT_TEXT'), Text::_('OSM_PROMPT_TEXT_EXPLAIN')); ?>
                    </div>
                    <div class="controls">
                        <input type="text" class="form-control" size="40" name="prompt_text"
                            value="<?php echo $this->item->prompt_text; ?>" />
                    </div>
                </div>
                <?php
                $showOnData = [
                    'fieldtype' => ['List', 'Checkboxes', 'Radio', 'Countries', 'State'],
                ];
                ?>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon($showOnData); ?>'>
                ...
                <div class="control-group">
                    <div class="control-label">
                        <?php echo OSMembershipHelperHtml::getFieldLabel('payment_method', Text::_('OSM_PAYMENT_METHOD'), Text::_('OSM_FIELD_PAYMENT_METHOD_EXPLAIN')); ?>
                    </div>
                    <div class="controls">
                ...
                <div class="control-group" id="depend_on_options_container"
                    style="display: <?php echo $this->item->depend_on_field_id ? '' : 'none'; ?>">
                    <div class="control-label">
                            ...
                            <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
                                ...
                                ?>
                                    <div class="<?php echo $span4Class; ?>">
                                        <input value="<?php echo $this->escape($value); ?>" type="checkbox"
                                            class="form-check-input" name="depend_on_options[]"
                                            <?php if (in_array($value, $this->dependOnOptions)) echo 'checked="checked"'; ?>><?php echo $value; ?>
                                    </div>
                                <?php
                                }
                                ?>
                ...
                <div class="control-group"
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="40" class="form-control"
                            name="joomla_group_ids"><?php echo $this->item->joomla_group_ids; ?></textarea>
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['List', 'Radio']]); ?>'
                    style="margin-top:10px;">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="40"
                            name="modify_subscription_duration"><?php echo $this->item->modify_subscription_duration; ?></textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Textarea']]); ?>'>
                    <div class="control-label">
                        <?php echo  Text::_('OSM_ROWS'); ?>
                    </div>
                    <div class="controls">
                        <input class="form-control" type="number" name="rows" id="rows" size="10" maxlength="250"
                            value="<?php echo $this->item->rows; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Textarea']]); ?>'>
                    ...
                    <div class="controls">
                        <input class="form-control" type="number" name="cols" id="cols" size="10" maxlength="250"
                            value="<?php echo $this->item->cols; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Checkboxes', 'Radio', 'List']]); ?>'>
                    <div class="control-label">
                        <?php echo  Text::_('OSM_SIZE'); ?>
                    </div>
                    <div class="controls">
                        <input class="form-control" type="number" name="size" id="size" size="10" maxlength="250"
                            value="<?php echo $this->item->size; ?>" />
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="form-control" type="text" name="container_class" id="container_class" size="10"
                            maxlength="250" value="<?php echo $this->item->container_class; ?>" />
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <input class="form-control" type="text" name="css_class" id="css_class" size="10"
                            maxlength="250" value="<?php echo $this->item->css_class; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Textarea']]); ?>'>
                    <div class="control-label">
                        <?php echo  Text::_('OSM_PLACE_HOLDER'); ?>
                    </div>
                    <div class="controls">
                        <input class="form-control" type="text" name="place_holder" id="place_holder" size="40"
                            maxlength="250" value="<?php echo $this->item->place_holder; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo OSMembershipHelperHtml::renderShowon(['fieldtype' => ['Text', 'Textarea']]); ?>'>
                    ...
                    <div class="controls">
                        <input class="form-control" type="number" name="max_length" id="max_length" size="40"
                            maxlength="250" value="<?php echo $this->item->max_length; ?>" />
                    </div>
                </div>
            </fieldset>
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group validation-rules">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" size="40" name="validation_rules"
                ...
                <div class="control-group validation-rules">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" size="40" name="server_validation_rules"
                            value="<?php echo $this->item->server_validation_rules; ?>" />
                    </div>
                </div>
                <div class="control-group validation-rules">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" size="40" name="validation_error_message"
                            value="<?php echo $this->escape($this->item->validation_error_message); ?>" />
                    </div>
                </div>
            </fieldset>
        </div>
    ...
    if ($translatable) {
        echo HTMLHelper::_('uitab.addTab', 'field', 'translation-page', Text::_('OSM_TRANSLATION'));
        echo HTMLHelper::_('uitab.startTabSet', 'field-translation', ['active' => 'translation-page-' . $this->languages[0]->sef, 'recall' => true]);
    ...
    ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="form-control" type="text" name="title_<?php echo $sef; ?>" id="title_<?php echo $sef; ?>"
                        size="" maxlength="250" value="<?php echo $this->item->{'title_' . $sef}; ?>" />
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <input class="form-control" type="text" name="place_holder_<?php echo $sef; ?>"
                        id="place_holder_<?php echo $sef; ?>" size="" maxlength="250"
                        value="<?php echo $this->item->{'place_holder_' . $sef}; ?>" />
                </div>
            </div>
            ...
            <div class="control-group" data-showon='<?php echo OSMembershipHelperHtml::renderShowon($showOnData); ?>'>
                ...
                <div class="controls">
                    <input class="form-control" type="text" name="prompt_text_<?php echo $sef; ?>"
                        id="prompt_text_<?php echo $sef; ?>" size="" maxlength="250"
                        value="<?php echo $this->item->{'prompt_text_' . $sef}; ?>" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea rows="5" cols="40" class="form-control"
                        name="description_<?php echo $sef; ?>"><?php echo $this->item->{'description_' . $sef}; ?></textarea>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <textarea rows="5" cols="40" class="form-control"
                        name="values_<?php echo $sef; ?>"><?php echo $this->item->{'values_' . $sef}; ?></textarea>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <textarea rows="5" cols="40" class="form-control"
                        name="default_values_<?php echo $sef; ?>"><?php echo $this->item->{'default_values_' . $sef}; ?></textarea>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <textarea class="form-control" rows="5" cols="40"
                        name="fee_values_<?php echo $sef; ?>"><?php echo $this->item->{'fee_values_' . $sef}; ?></textarea>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <input class="form-control" type="text" name="validation_error_message_<?php echo $sef; ?>"
                        id="validation_error_message_<?php echo $sef; ?>" size="" maxlength="250"
                        value="<?php echo $this->item->{'validation_error_message_' . $sef}; ?>" />
                </div>
            </div>
    <?php
            echo HTMLHelper::_('uitab.endTab');
    ...
    if ($hasCustomSettings) {
        echo HTMLHelper::_('uitab.addTab', 'field', 'custom-settings-page', Text::_('OSM_CUSTOM_SETTINGS'));
