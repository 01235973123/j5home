...
if (!in_array('multiple_files', $fields)) {
    $sql = "ALTER TABLE  `#__eb_fields` ADD  `multiple_files` TINYINT NOT NULL DEFAULT  '0';";
    $db->setQuery($sql)
        ->execute();
}
...
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm"
    ...
    <div class="<?php echo $rowFluid; ?>">
        <div class="<?php echo $span6; ?>">
            <fieldset class="form-horizontal options-form">
                ...
                ?>
                    ...
                    <div class="control-group"
                        data-showon='<?php echo EventbookingHelperHtml::renderShowon(['assignment' => ['1', '-1']]); ?>'>
                        <div class="control-label">
                ...
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['Text', 'Email', 'Email', 'Number', 'Tel', 'Textarea', 'Password']]); ?>'>
                    <div class="control-label">
        ...
        <div class="<?php echo $span6; ?>">
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['File']]); ?>'>
                    <div class="control-label">
                        <?php echo Text::_('EB_MULTIPLE_FILES'); ?>
                    </div>
                    <div class="controls">
                        <?php echo EventbookingHelperHtml::getBooleanInput('multiple_files', $this->item->multiple_files); ?>
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['List']]); ?>'>
                    <div class="control-label">
                        <?php echo EventbookingHelperHtml::getFieldLabel('prompt_text', Text::_('EB_PROMPT_TEXT'), Text::_('EB_PROMPT_TEXT_EXPLAIN')); ?>
                    </div>
                    <div class="controls">
                        <input type="text" name="prompt_text" value="<?php echo $this->item->prompt_text; ?>"
                            class="form-control" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['Number', 'Range']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['List', 'SQL']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['List', 'Checkboxes', 'Radio']]); ?>'>
                    <div class="control-label">
                        <?php echo EventbookingHelperHtml::getFieldLabel('values', Text::_('EB_VALUES'), Text::_('EB_EACH_ITEM_LINE')); ?>
                    </div>
                    <div class="controls">
                        <textarea rows="5" cols="50" name="values"
                            class="input-xlarge form-control"><?php echo $this->item->values; ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="50" name="default_values"
                            class="input-xlarge form-control"><?php echo $this->item->default_values; ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fee_field' => '1']); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="50" name="fee_values"
                            class="input-xlarge form-control"><?php echo $this->item->fee_values; ?></textarea>
                    </div>
                </div>
                <?php
                $showOnData = [
                ...
                ?>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon($showOnData); ?>'>
                    <div class="control-label">
                        <?php echo EventbookingHelperHtml::getFieldLabel('fee_formula', Text::_('EB_FEE_FORMULA'), Text::_('EB_FEE_FORMULA_EXPLAIN')); ?>
                    </div>
                    <div class="controls">
                        <input type="text" class="form-control" size="50" name="fee_formula"
                            value="<?php echo $this->item->fee_formula; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['Text', 'Tel', 'Range', 'Number']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="50" name="quantity_values"
                            class="input-xlarge form-control"><?php echo $this->item->quantity_values; ?></textarea>
                    </div>
                </div>
                <?php
                $showOnData = [
                ...
                ?>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['display_in' => ['1', '2', '3']]); ?>'>
                    <div class="control-label">
            ...
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['Text', 'Textarea']]); ?>'>
                    <div class="control-label">
                        <?php echo  Text::_('EB_PLACE_HOLDER'); ?>
                    </div>
                    <div class="controls">
                        <input class="form-control" type="text" name="place_holder" id="place_holder" size="50"
                            maxlength="250" value="<?php echo $this->item->place_holder; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['Text', 'Checkboxes', 'Radio', 'List']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group"
                    ...
                    <div class="controls">
                        <input class="form-control" type="number" name="max_length" id="max_lenth" size="50"
                            maxlength="250" value="<?php echo $this->item->max_length; ?>" />
                    </div>
                </div>
                <div class="control-group"
                    data-showon='<?php echo EventbookingHelperHtml::renderShowon(['fieldtype' => ['Textarea']]); ?>'>
                    <div class="control-label">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="form-control" type="text" name="extra_attributes" id="extra" size="40"
                            maxlength="250" value="<?php echo $this->item->extra_attributes; ?>" />
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
            ...
            <fieldset class="form-horizontal options-form">
                ...
                <div class="control-group validation-rules">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control input-xlarge" size="50" name="validation_rules"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="input-xlarge form-control" type="text" name="server_validation_rules"
                            id="server_validation_rules" size="10" maxlength="250"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="input-xlarge form-control" type="text" name="validation_error_message"
                            id="validation_error_message" size="10" maxlength="250"
                            value="<?php echo $this->item->validation_error_message; ?>" />
                    </div>
                </div>
            </fieldset>
        </div>
    ...
    ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-xlarge form-control" type="text" name="title_<?php echo $sef; ?>"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea class="input-xlarge form-control" rows="5" cols="50"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-xlarge form-control" type="text" name="place_holder_<?php echo $sef; ?>"
