--
-- Table structure for table `#__jd_campaigns`
--

CREATE TABLE IF NOT EXISTS `#__jd_campaigns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) DEFAULT NULL,
  `campaign_photo` varchar(255) NOT NULL,
  `description` text,
  `start_date` datetime DEFAULT NULL,
  `end_date` datetime DEFAULT NULL,
  `goal` decimal(10,2) DEFAULT NULL,
  `amounts` text,
  `amounts_explanation` text,
  `donated_amount` decimal(10,2) DEFAULT '0.00',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `user_email_subject` varchar(255) DEFAULT NULL,
  `user_email_body` text,
  `recurring_email_subject` varchar(255) DEFAULT NULL,
  `recurring_email_body` text,
  `notification_emails` varchar(255) DEFAULT NULL,
  `donation_form_msg` text,
  `confirmation_message` text,
  `thanks_message` text,
  `cancel_message` text,
  `published` tinyint(3) UNSIGNED DEFAULT '0',
  `paypal_id` varchar(255) DEFAULT NULL,
  `enable_recurring` tinyint(4) NOT NULL DEFAULT '1',
  `alias` varchar(255) DEFAULT NULL,
  `donation_type` tinyint(4) NOT NULL DEFAULT '0',
  `show_campaign` tinyint(1) NOT NULL DEFAULT '-1',
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `#__jd_configs`
--

CREATE TABLE IF NOT EXISTS `#__jd_configs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__jd_countries`
--
DROP TABLE IF EXISTS `#__jd_countries` ;
CREATE TABLE `#__jd_countries` (
...
--
-- Dumping data for table `#__jd_countries`
--

INSERT INTO `#__jd_countries` (`country_id`, `zone_id`, `name`, `country_3_code`, `country_2_code`, `published`) VALUES
...
CREATE TABLE IF NOT EXISTS `#__jd_currencies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__jd_donors`
--

CREATE TABLE IF NOT EXISTS `#__jd_donors` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `hide_me` tinyint(4) NOT NULL DEFAULT '0',
  `published` tinyint(4) NOT NULL DEFAULT '0',
  `donation_type` varchar(50) DEFAULT NULL,
  `r_times` int(11) DEFAULT NULL COMMENT 'Number of donations',
  `r_frequency` varchar(255) DEFAULT NULL COMMENT 'Donation Frequency',
  `payment_made` int(4) NOT NULL DEFAULT '0',
  ...
  `mollie_recurring_start_date` datetime NOT NULL,
  `agree_privacy_policy` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `#__jd_fields`
--
...
--
-- Table structure for table `#__jd_field_value`
--

CREATE TABLE IF NOT EXISTS `#__jd_field_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `#__jd_field_value`
--
DROP TABLE IF EXISTS `#__jd_states`;
CREATE TABLE IF NOT EXISTS `#__jd_states` (
...
--
-- Dumping data for table `jos_jd_states`
--

INSERT INTO `#__jd_states` (`state_id`, `country_id`, `state_name`, `state_3_code`, `state_2_code`) VALUES
...
CREATE TABLE IF NOT EXISTS `#__jd_payment_plugins` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__jd_menus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__jd_urls` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `md5_key` text,
  `query` text,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `#__jd_emails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__jd_email_templates` (
